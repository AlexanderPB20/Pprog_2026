...
/**
 * @test Test for max_objs of player's backpack setting 
 * @pre Valid pointer to Player and valid max_objs
 * @post Output == OK
 */
...
/**
 * @test Test for max_objs of player's backpack setting 
 * @pre Player==NULL and valid max_objs
 * @post Output == ERROR
 */
...
/**
 * @test Test for max_objs of player's backpack setting 
 * @pre Valid pointer to Player and not valid max_objs (max_objs<0)
 * @post Output == ERROR
 */
void test3_player_set_max_objs();

/**
 * @test Test setting the max objects of a player
 * @pre Valid player, invalid max_objs (bigger than macro MAX_OBJS)                   --------> Test a editar dependiendo de si hay MAX_OBJS a parte de un MAX_OBJECTS
 * @post Output == ERROR
 */
